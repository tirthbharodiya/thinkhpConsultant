...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container-fluid row">
            <div class="col-lg-6 para-content ">
                ...
                <p style="text-align:justify;">Thinkhp consultant is a leading web development company delivering best service to the client. like
            ...
            <div class="col-lg-6 login-container">
                <form action="userAuthentication/loginuser.php" method="post">
                    ...
                    <div class="form-group">
                        <button type="submit" name="submit" onclick="fun1()" class="btn btn-primary loginbtn btn-block">Login</button>
                    </div>

                    <div class="form-group">
                        <p class="text-center text-muted">Don't have an account? <a href="userAuthentication/signup.php" class=""><u>Register</u></a></p>
                    </div>

                    <div class="icons">
                        <a target="_main" href="https://www.facebook.com/people/Hitesh-Patel/pfbid0cUWt7a6umpiKMivpWTenxA8m2Wqdscd9G4FvFzhsTyGcv8yQxaVv6AUceZRg1Fmol/?mibextid=ZbWKwL">
                            <a target="_main" href="https://www.instagram.com/thinkhpconsultant/"><ion-icon class="insta" name="logo-instagram"></ion-icon></a>
                            <a target="_main" href="https://twitter.com/ThinkHP82"><ion-icon class="twitter" name="logo-twitter"></ion-icon></a>
                            <a target="_main" href="https://www.linkedin.com/in/thinkhpconsultant-llp-88242926a/?original_referer="><ion-icon class="linkedin" name="logo-linkedin"></ion-icon></a>
                            <a target="_main" href="https://www.youtube.com/@thinkhpconsultant/featured"><ion-icon class="youtube" name="logo-youtube"></ion-icon></a>
                    </div>
    ...
    <section class="page-section" id="about">
        <div class="container">
            ...
            <ul class="timeline">
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/bkgd.jpg" alt="..." /></div>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/vsn.jpeg" alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                ...
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/about/contact1.jpeg" alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>CONTACT US</h4>
                        </div>
                        <div class="timeline-body">
                            ...
                            <p class="text-muted"><a href="tel:+91 8128220199"><i class="fa-1x fa-solid fa-phone contactUsLogo "></i>+91 8128220199</a></p>
                            ...
                            <p class="text-muted"><a href="https://maps.app.goo.gl/pRNzTM5LRvAaP8ZX7"><i class="fa-1x fa-solid fa-location-dot contactUsLogo "></i>111, Soham Arcade, pal, bhata, Surat, Gujarat,</a> </p>
                        </div>
                    </div>
                </li>
                ...
                <li class="timeline-inverted">
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p class="text-muted"><a target="_main" href="https://www.instagram.com/thinkhpconsultant/"><ion-icon class="insta contactUsLogo " name="logo-instagram"></ion-icon>thinkhpconsultant</a>
                            </p>

                            <p class="text-muted"><a target="_main" href="https://twitter.com/ThinkHP82"><ion-icon class="twitter contactUsLogo " name="logo-twitter"></ion-icon>Think HP Consultant</a>
                            </p>
                            <p class="text-muted"><a target="_main" href="https://www.youtube.com/@thinkhpconsultant/featured"><ion-icon class="youtube contactUsLogo " name="logo-youtube"></ion-icon>ThinkHPconsultant</a>
                            </p>
            ...
            <form id="contactForm" action="user/feedback/feedback.php" method="post">
                ...
                <div class="row align-items-stretch mb-5">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <!-- Email address input-->
                            <input class="form-control" id="email" name="userEmail" type="email" placeholder="Your Email *" required />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-group-textarea mb-md-0">
                            <!-- Phone number input-->
                            <textarea class="form-control" rows="8" id="title" name="message" type="text" placeholder="Your Feedback*" required /></textarea>
                            <div class="invalid-feedback" data-sb-feedback="message:required">A message is required.
                            </div>
                            <div class="invalid-feedback" data-sb-feedback="phone:required">A title number is required.
                            </div>
                        </div>
                    </div>
                </div>
